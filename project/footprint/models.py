...
class IP2Location(models.Model):
    """ Represents IP Geolocation data """
...
class ConvertedPackets(models.Model):
    """ Intermediate model for storing captured packets """
...
class LivePackets(models.Model):
    ...
    src_country_name = models.CharField(max_length=64, null=False)
    ...
    dst_country_name = models.CharField(max_length=64, null=False)
